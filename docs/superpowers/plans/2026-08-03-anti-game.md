...
- [x] **Step 1: Sahte oyun binary'sini ve test yardımcısını yaz**
...
- [x] **Step 3: wininput paketini yaz**
...
- [x] **Step 6: Spec'teki mutex adını düzelt**
...
- [x] **Step 1: Başarısız birim testlerini yaz**
...
- [x] **Step 4: Birim testlerinin geçtiğini doğrula**

Run: `go test ./internal/watch/ -v`
Expected: PASS, 10 test

- [x] **Step 5: Gerçek process ile entegrasyon testini yaz**
...
- [x] **Step 6: Entegrasyon testinin geçtiğini doğrula**

Run: `go test ./internal/watch/ -run TestRealProcess -v`
Expected: PASS

- [x] **Step 7: Alt komutu bağla**
...
- [x] **Step 3: gamelist paketini yaz**
...
- [x] **Step 1: İzleyiciye nabız olayı testini yaz**
...
- [x] **Step 3: İzleyiciye nabız olayını ekle**
...
- [x] **Step 6: Testin başarısız olduğunu doğrula**

Run: `go test ./internal/report/ -v`
Expected: FAIL — `undefined: Aggregate`

- [x] **Step 7: Toplamayı yaz**
...
- [x] **Step 8: Testin geçtiğini doğrula**

Run: `go test ./internal/report/ -v`
Expected: PASS, 8 test

- [x] **Step 9: HTML üretimini yaz**
...
- [x] **Step 10: Derlendiğini ve testlerin geçtiğini doğrula**

Run: `go test ./... && go vet ./...`
Expected: tüm paketler PASS

- [x] **Step 11: Alt komutu bağla**
...
- [x] **Step 1: WorkingSet testini yaz**
...
- [x] **Step 3: WorkingSet fonksiyonunu ekle**
...
- [x] **Step 7: Bütçe testini çalıştır**
...
- [x] **Step 8: Kaldırma komutunun testini yaz**
...
- [x] **Step 9: Testin başarısız olduğunu doğrula**

Run: `go test ./internal/uninstall/ -v`
Expected: FAIL — `undefined: run`

- [x] **Step 10: uninstall paketini yaz**
...
- [x] **Step 11: Testin geçtiğini doğrula**

Run: `go test ./internal/uninstall/ -v`
Expected: PASS, 3 test

- [x] **Step 12: Son alt komutu bağla ve tüm paketi doğrula**
